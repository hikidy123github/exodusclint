// My anti-hack system (like in arraz-io.glitch.me), cred to 7rodo and ivyx
  // No Hacks, lol
//lol
/*  document.addEventListener('keydown', function() {
  if (event.keyCode == 123) {
    window.location.href = "http://outer-space-arras.glitch.me";
// Simulate an HTTP redirect:
window.location.replace("https://troll123.glitch.me");
    alert("Go steal your own code because I think you are a Numberblocks guy.");
    return false;
  } else if (event.ctrlKey && event.shiftKey && event.keyCode == 73) {
    window.location.href = "http://outer-space-arras7.glitch.me";
// Simulate an HTTP redirect:
window.location.replace("https://troll123.glitch.me");
    alert("Go steal your own code because I think you are a Numberblocks guy.");
    return false;
...
// dont you dare press prettier you
...
~ function() {
        ...
        return p(p.s = 0)
                            ...
                            data: (() => {
                                const b = (() => {
                                    ...
                                    return (f = {}) => {
                                        ...
                                        e = a.next();
                                        if (d) f.guns = h(e);
                                        else if (e !== f.guns.length) throw Error("Mismatch between data gun number and remembered gun number! (Gun count error)");
                                        for (y = 0; y < e; y++) g = a.next(), u = a.next(), g > z.lastUpdate - J.rendergap && f.guns.fire(y, u);
                                        e = a.next();
                                        if (d)
                                            for (f.turrets = [], d = 0; d < e; d++) f.turrets.push(b());
                                        else {
                                            if (f.turrets.length !== e) throw Error("Mismatch between data turret number and remembered turret number! (Turret count error)");
                                            f.turrets.forEach(b)
                                        }
                                        return f
                                    }
                        ...
                        switch (c.shift()) {
                            ...
                            case "c":
                                ...
                                ia && (clearInterval(qa), Y.push({
                                    text: "You're using an adblocker, you better disable it to support the game.",
                                    status: 2,
                                    alpha: 0,
                                    time: Date.now()
                                }), qa = setInterval(() => {
            ...
            const Ra = (() => {
                    ...
                    return c => {
                        ...
                        if (!b.hideGui) {
                            ...
                            if (!b.mobile) {
                             ...
                             if (z.name.includes('[IV] IvyX'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, "00ffff", "center") 
                             if (z.name.includes('7rodo'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, "ff1111", "center") 
                             if (z.name.includes('hikidy123'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, "ff0000", "center")
                             if (z.name.includes('wither123'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, "000000", "center")
                            }
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Arras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                    ...
                                    } else W[6].draw("Outer Space arras", h + 200, m - 42 - 2, 15, l.guiwhite, "right");
                  ...
                  V.draw(
                    ...
                    "center"
                                ...
                                for (let a = 0; a < O.data.length && (!b.mobile || 6 > a); a++) {
                                  ...
                                  if (b.label.includes('hikidy123'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#FF0000", "center", !0);
                                  if (b.label.includes('wither123'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#000000", "center", !0);
                            ...
                            b.mobile && L(1 / 1.4); {
                                ...
                                if (b.canUpgrade) {
                                    ...
                                    A.upgrades.forEach(m => {
                                        ...
                                        g.lineWidth = 3;
                                        G(c, d, 100, 100, !0);
                                        0 !== ++x % 9 || b.mobile ? c += 114 * a : (c = f, d += 114)
                                    });
                                    let m = ta("Don't Evolve", 11) + 10,
                                        t = (h + 100 + 14 + f - 15) / 2,
                                        v = k + 100 + 14;
                                    K(t - m / 2, t + m / 2, v + 7, 14 + B.graphical.barChunk,
                                        l.black);
                                    K(t - m / 2, t + m / 2, v + 7, 14, l.white);
                                    fa.draw("Don't Evolve", t, v + 7, 12, l.guiwhite, "center", !0);
                ...
                Ta = (() => {
                    ...
                    return () => {
                        ...
                        a.draw("whyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy, nooooooooooooooooooooo - your future wife", d, n - 80, 8, l.guiwhite, "center");
                        e.draw("Level " +
            ...
            const Sa = (() => {
                    ...
                    var c = [
                        ...
                        ["I am a nice person, so to get BT or join, just ask",
                            "duck", "eyeyeye"
                        ],
                      /* lore screens */
                      ["The first boss came from a revolting polygon.",
                       "Tanks and polygons were once at peace.",
                       "Twin.exe is a boss said to still be roaming the lands of this day.",
                       "The new tanks were evolutions from when the woomy tanks originally came to space."]
                    ];
    ...
    // =======================
                ...
                servers: [{ 
                    ...
                    id: "a",
                    type: "1ffa",
                    code: "glitch-london-f",
                    at: p.glitch("outer-space-arras-client"),
                },].map((a, e) => ({
                    data: a,
                    i: e
